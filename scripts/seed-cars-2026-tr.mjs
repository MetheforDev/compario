/**
 * seed-cars-2026-tr.mjs
 * Türkiye 2026 pazarının en popüler araçları — görsellerle birlikte.
 * Mevcut slug varsa atlanır (idempotent).
 * Çalıştır: cd scripts && node seed-cars-2026-tr.mjs
 */
...
async function main() {
  console.log('🚀 Türkiye 2026 araç seed\'i başlıyor...\n');
  ...
  const PRODUCTS = [
...

    {
      ...
      name: 'RAV4 Hybrid', slug: 'toyota-rav4-hybrid-2026',
      brand: 'Toyota', model: 'RAV4 Hybrid', model_year: 2026,
      ...
      meta_title: 'Toyota RAV4 Hybrid 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Toyota RAV4 Hybrid 2026Türkiye fiyatı 2.650.000 TL. 222 HP, AWD-i, 5.5 L/100km yakıt tüketimi.',
    },

    {
      category_id: suvId, segment_id: hybridSuvSeg,
      name: 'Tucson Hybrid', slug: 'hyundai-tucson-hybrid-2026',
      brand: 'Hyundai', model: 'Tucson Hybrid', model_year: 2026,
      ...
      meta_title: 'Hyundai Tucson Hybrid 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Hyundai Tucson Hybrid 2026fiyatı 2.200.000 TL. 230 HP, AWD, panoramik tavan.',
    },

    {
      category_id: suvId, segment_id: hybridSuvSeg,
      name: 'Sportage Hybrid', slug: 'kia-sportage-hybrid-2026',
      brand: 'Kia', model: 'Sportage Hybrid', model_year: 2026,
      ...
      meta_title: 'Kia Sportage Hybrid 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Kia Sportage Hybrid 2026fiyatı 2.150.000 TL. 230 HP AWD hibrit, 7 yıl garanti.',
    },

    {
      category_id: suvId, segment_id: hybridSuvSeg,
      name: 'Tiguan 1.5 TSI', slug: 'volkswagen-tiguan-2026',
      brand: 'Volkswagen', model: 'Tiguan', model_year: 2026,
      ...
      meta_title: 'Volkswagen Tiguan 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'VW Tiguan 2026Türkiye fiyatı 2.450.000 TL. 3. nesil, 15 inç ekran, mild hibrit.',
    },
...

    {
      ...
      name: 'Corolla Cross Hybrid', slug: 'toyota-corolla-cross-hybrid-2026',
      brand: 'Toyota', model: 'Corolla Cross Hybrid', model_year: 2026,
      ...
      meta_title: 'Toyota Corolla Cross Hybrid 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Toyota Corolla Cross Hybrid 2026fiyatı 1.950.000 TL. 196 HP, 5 L/100km yakıt tüketimi.',
    },

    {
      category_id: crossId, segment_id: crossSeg,
      name: 'HR-V e:HEV', slug: 'honda-hrv-ehev-2026',
      brand: 'Honda', model: 'HR-V e:HEV', model_year: 2026,
      ...
      meta_title: 'Honda HR-V e:HEV 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Honda HR-V e:HEV 2026fiyatı 1.900.000 TL. Tam paralel hibrit, 5 L/100km.',
    },
...

    {
      ...
      name: 'Corolla Hybrid', slug: 'toyota-corolla-sedan-hybrid-2026',
      brand: 'Toyota', model: 'Corolla Hybrid', model_year: 2026,
      ...
      meta_title: 'Toyota Corolla Hybrid 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Toyota Corolla Hybrid 2026fiyatı 1.580.000 TL. 4.3 L/100km yakıt, 140 HP.',
    },

    {
      category_id: sedanId, segment_id: ortaSedanSeg,
      name: 'Elantra Hybrid', slug: 'hyundai-elantra-hybrid-2026',
      brand: 'Hyundai', model: 'Elantra Hybrid', model_year: 2026,
      ...
      meta_title: 'Hyundai Elantra Hybrid 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Hyundai Elantra Hybrid 2026fiyatı 1.550.000 TL. 141 HP hibrit, 4.8 L/100km.',
    },

    {
      category_id: sedanId, segment_id: ortaSedanSeg,
      name: 'K4 Hybrid', slug: 'kia-k4-hybrid-2026',
      brand: 'Kia', model: 'K4 Hybrid', model_year: 2026,
      ...
      meta_title: 'Kia K4 Hybrid 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Kia K4 Hybrid 2026Türkiye fiyatı 1.620.000 TL. 7 yıl garanti, çift 12.3" ekran.',
    },
...

    {
      ...
      name: '3 Serisi 320i', slug: 'bmw-3-serisi-2026',
      brand: 'BMW', model: '3 Serisi', model_year: 2026,
      ...
      meta_title: 'BMW 3 Serisi 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'BMW 3 Serisi 320i 2026fiyatı 3.100.000 TL. 184 HP, RWD, Curved Display.',
    },

    {
      category_id: sedanId, segment_id: luksSedanSeg,
      name: 'C Serisi C200', slug: 'mercedes-c-serisi-2026',
      brand: 'Mercedes-Benz', model: 'C-Serisi', model_year: 2026,
      ...
      meta_title: 'Mercedes C200 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Mercedes C-Serisi C200 2026fiyatı 3.400.000 TL. 204 HP mild hybrid, MBUX.',
    },
...

    {
      ...
      name: 'Golf 2.0 TDI', slug: 'volkswagen-golf-2026',
      brand: 'Volkswagen', model: 'Golf', model_year: 2026,
      ...
      meta_title: 'Volkswagen Golf 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'VW Golf 8.5 2026fiyatı 1.600.000 TL. 150 HP TDI, ChatGPT entegrasyonu.',
    },

    {
      category_id: hatchId, segment_id: komHatchSeg,
      name: 'Clio E-Tech Hybrid', slug: 'renault-clio-etech-2026',
      brand: 'Renault', model: 'Clio E-Tech Hybrid', model_year: 2026,
      ...
      meta_title: 'Renault Clio E-Tech Hybrid 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Renault Clio E-Tech Hybrid 2026fiyatı 1.150.000 TL. 145 HP full hybrid, 4.4 L/100km.',
    },

    {
      category_id: hatchId, segment_id: komHatchSeg,
      name: 'i20 Hybrid', slug: 'hyundai-i20-hybrid-2026',
      brand: 'Hyundai', model: 'i20 Hybrid', model_year: 2026,
      ...
      meta_title: 'Hyundai i20 Hybrid 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Hyundai i20 Hybrid 2026fiyatı 1.050.000 TL. 48V mild hybrid, 5 yıl garanti.',
    },

    {
      category_id: hatchId, segment_id: komHatchSeg,
      name: 'Yaris Hybrid', slug: 'toyota-yaris-hybrid-2026',
      brand: 'Toyota', model: 'Yaris Hybrid', model_year: 2026,
      ...
      meta_title: 'Toyota Yaris Hybrid 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Toyota Yaris Hybrid 2026fiyatı 1.250.000 TL. 3.8 L/100km yakıt, 130 HP.',
    },
...

    {
      ...
      name: 'Model Y', slug: 'tesla-model-y-2026',
      brand: 'Tesla', model: 'Model Y', model_year: 2026,
      ...
      meta_title: 'Tesla Model Y 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Tesla Model Y Juniper 2026Türkiye fiyatı 2.650.000 TL. 533 km menzil, Autopilot.',
    },

    {
      category_id: suvId, segment_id: elektrikSuvSeg,
      name: 'EV6 GT-Line', slug: 'kia-ev6-2026',
      brand: 'Kia', model: 'EV6', model_year: 2026,
      ...
      meta_title: 'Kia EV6 2026Fiyat ve Özellikleri | Compario',
      meta_description: 'Kia EV6 2026fiyatı 2.950.000 TL. 800V hızlı şarj, 528 km menzil, 7 yıl garanti.',
    },
  ];
  ...
  console.log('🎉 Türkiye 2026araç seed\'i tamamlandı!');
}
